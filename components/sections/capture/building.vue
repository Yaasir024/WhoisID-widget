    ...
    <div class="">
      ...
      <transition name="modal">
        ...
        >
          ...
          >
            <button class="absolute top-[20px] right-[20px] flex items-center justify-center h-[38px] w-[38px] rounded-full bg-white/30">
              <img
            ...
            <h1 class="text-[18px] leading-[32px] font-medium text-center">Take an image of your utility building</h1>
            <div class="">
            ...
            <div class="flex flex-col items-center justify-center">
                <h1 class="text-[18px] leading-[32px] font-medium text-center mb-[24px]">Ensure the image fits in this frame</h1>
                <img
