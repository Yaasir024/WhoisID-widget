...
<template>
  ...
  >
    <div
      class="modal max-w-[430px] w-full bg-white mt-auto p-[24px] overflow-y-auto pb-[120px]"
    >
      <div
        class="text-id-dark-1 text-[20px] font-semibold leading-[28px] pb-[12px] border-b mb-[24px]"
      >
        Privacy Policy
      </div>
      <div class="text-[14px] leading-[25px] text-[#667085]">
      ...
      <div class="">
        <ReuseableButton text="Continue" />
        <div class="flex justify-center w-full mt-[10px]">
          <button class="flex items-center" @click="$emit('close')">
            <img src="@/assets/images/arrow-left.svg" alt="" class="mr-[4px]" />
            <span class="text-[21px] leading-[38px] font-medium text-[#188A8E]"
              >Back</span
            >
          </button>
        </div>
